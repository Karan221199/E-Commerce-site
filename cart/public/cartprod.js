...
function addProducttoDOM(newObj)
{
 ...
 // getretrivedProducts();
  ...
  label1.setAttribute("style","font-size:1.5em;  margin-left:15px;");
  label2.setAttribute("style","font-size:1.5em;  margin-left:15px;");
  label3.setAttribute("style","font-size:1.5em;  margin-left:15px;");
  label4.setAttribute("style","font-size:1.5em; margin-left:15px;");
  ...
  deleteCart.setAttribute("style","height:30px; color:black;  font-size: 12px; border:none; margin-left:10px; margin-top:30px;");
