...
function addProducttoDOM(newObj)
{
  ...
  label1.innerHTML=pid+")Name: "+prodName;
  label2.innerHTML="Desc: "+prodDesc;
  ...
  addToCart.setAttribute("style","height:30px; color:black; font-size: 12px; border:none; margin-left:10px; ");
...
function next(){
  ...
  if(start<retrievedArray.length-4)
  {
    start=start+4;
